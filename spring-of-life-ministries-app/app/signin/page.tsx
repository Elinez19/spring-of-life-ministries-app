        ...
        <div className="absolute left-0 top-0 z-[-1]">
          ...
          >
            <mask
              ...
              height="969"
            >
              <rect width="1440" height="969" fill="#340932" />
            </mask>
            ...
            <defs>
              ...
              >
                <stop stopColor="#660D57" />
                <stop offset="1" stopColor="#F74AF7" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#7C1081" />
                <stop offset="1" stopColor="#6E0F63" stopOpacity="0" />
              </linearGradient>
            </defs>
          </svg>
        </div>
