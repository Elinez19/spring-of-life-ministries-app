        ...
        <div className="container">
          ...
          <div className="py-8">
            <p className="text-center text-base text-body-color dark:text-white">
              Developed with💖by Purplebeetech and{" "}
              <a
                href="https://school.purplebeetech.com/"
                rel="nofollow noopener"
              >
                Purplebeetech academy
              </a>
            </p>
          </div>
        </div>
          ...
          >
            ...
            <defs>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#640A71" stopOpacity="0.62" />
                <stop offset="1" stopColor="#60075D" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#E04AF7" stopOpacity="0" />
                <stop offset="1" stopColor="#660C68" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#48074F" stopOpacity="0.62" />
                <stop offset="1" stopColor="#470748" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#580B65" stopOpacity="0" />
                <stop offset="1" stopColor="#640C63" stopOpacity="0.51" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#EC4AF7" stopOpacity="0.62" />
                <stop offset="1" stopColor="#F74AE6" stopOpacity="0" />
              </linearGradient>
              <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
              >
                <stop stopColor="#5E0B61" stopOpacity="0" />
