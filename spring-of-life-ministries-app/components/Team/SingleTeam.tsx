...
const SingleTeam = ({ team }: { team: TeamType }) => {
  ...
  return (
    <div className="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
      <div className="shadow-testimonial group mb-8 rounded-xl bg-white px-5 pb-10 pt-12 dark:bg-dark dark:shadow-none">
        ...
        <div className="text-center">
          <h3 className="mt-2 pt-10 text-lg font-semibold text-dark dark:text-white">
            {name}
          </h3>
          <p className="dark:text-dark-6 mb-5 text-sm text-body-color">
            {designation}
          </p>
